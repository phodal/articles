...
开源是一种社区行为，不是靠单一的编码能力，也只靠谁的代码写得好。一个优秀的开源软件，需要由一系列的因素构建，除了代码之后，有易用性、上手速度、文档丰富度、问题响应速度、接受反馈水平的等等。
...
> 你是否想一提到某个开源伤口，就会联想到你？你是否也想拥有一个可以写在简历上的开源作品？你是否也想创建一个 star 过千的项目？

你是否想一提到某个开源伤口，就会联想到你？你是否也想拥有一个可以写在简历上的开源作品？你是否也想创建一个 star 过千的项目？

这篇文章，将带你更好地去创建一个开源作品。
...
[^github]: 粉丝数按 location:china 搜索、提交数根据 [http://git.io/top](http://git.io/top) 计算得出、star 数按 [https://gitstar-ranking.com/users](https://gitstar-ranking.com/users) 计算得出
